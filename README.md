...
- [v0.2.0 release](https://github.com/kuotunyu/WoundScope/releases/tag/v0.2.0)：軟體 release、repository hardening 與 permission boundary。
...
- [DATA_CARD.md](DATA_CARD.md)／[MODEL_CARD.md](MODEL_CARD.md)：資料治理、實驗協議、模型成果與使用邊界。
